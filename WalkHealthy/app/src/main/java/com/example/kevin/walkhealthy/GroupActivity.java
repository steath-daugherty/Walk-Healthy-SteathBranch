...
public class GroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDataRef = FirebaseDatabase.getInstance().getReference().child("Groups");
        ...
        saveGroupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(userNameString) && !TextUtils.isEmpty(userCityString) && !TextUtils.isEmpty(userStateString) && !TextUtils.isEmpty(userCollegeString))
                {
                    ...
                    mChildDatabase.child("GroupName").setValue(userNameString);
                    mChildDatabase.child("Difficulty").setValue(userCityString);
                    mChildDatabase.child("MeetingLocation").setValue(userStateString);
                    mChildDatabase.child("College").setValue(userCollegeString);

                    Toast.makeText(GroupActivity.this, "Group Created!", Toast.LENGTH_LONG).show();

                    startActivity(new Intent(GroupActivity.this, WelcomeActivity.class));
